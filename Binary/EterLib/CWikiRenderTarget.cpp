...
CWikiRenderTarget::CWikiRenderTarget(const _wuint32 width, const _wuint32 height) :
...
void CWikiRenderTarget::SelectModel(const _wuint32 model_vnum)
{
...
void CWikiRenderTarget::SetArmor(_wuint32 vnum)
{
	if (!m_pModel)
		return;
...
void CWikiRenderTarget::SetWeapon(_wuint32 vnum)
{
	if (!m_pModel)
		return;
...
void CWikiRenderTarget::SetHair(_wuint32 vnum)
{
	if (!m_pModel)
		return;
...
void CWikiRenderTarget::SetModelV3Eye(_wfloat x, _wfloat y, _wfloat z)
{
	m_v3Eye.x = x;
	m_v3Eye.y = y;
	m_v3Eye.z = z;
...
void CWikiRenderTarget::SetModelV3Target(_wfloat x, _wfloat y, _wfloat z)
{
	m_v3Target.x = x;
	m_v3Target.y = y;
	m_v3Target.z = z;
