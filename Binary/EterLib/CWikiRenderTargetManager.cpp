...
std::shared_ptr<CWikiRenderTarget> CWikiRenderTargetManager::GetRenderTarget(const _wint32 module_id)
{
...
bool CWikiRenderTargetManager::CreateRenderTarget(const _wint32 module_id, const _wint32 width, const _wint32 height)
{
...
void CWikiRenderTargetManager::DeleteRenderTarget(const _wint32 module_id)
{
